...
export function attendanceSummary(data: any) {
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><strong>${rows.reduce((sum: number, r: any) => sum + r.wage_amount, 0)}</strong></td>
                </tr>
            </tbody>
        </table>
...
export function wageDeclaration(data: any) {
    const { company, project, period, rows } = data;
    return `
    <html>
